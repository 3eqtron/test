jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", zubinCustomizerReset.confirm, zubinCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                wp_customize: "on",
                action: "zubin_cusomizer_reset",
                nonce: zubinCustomizerReset.nonce.reset,
                section: o[1]
            };
